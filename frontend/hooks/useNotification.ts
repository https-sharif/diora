...
export const useNotification = () => {
  ...
  const handleIncomingNotification = useNotificationStore((state: NotificationStore) => state.handleIncomingNotification);
  const markAsRead = useNotificationStore((state: NotificationStore) => state.markAsRead);
  const markAllAsRead = useNotificationStore((state: NotificationStore) => state.markAllAsRead);
  const deleteNotification = useNotificationStore((state: NotificationStore) => state.deleteNotification);
  const clearAllNotifications = useNotificationStore((state: NotificationStore) => state.clearAllNotifications);
